...
串口数据接收和发送数据的模式分为 3 种：中断模式、轮询模式、DMA
...
调用这个函数时，回调函数由调用者提供，当硬件设备发送完数据时，由设备驱动程序回调这个函数并把发送完成的数据块地址
...
![串口DMA接收及轮询发送序列图](../../../../image/IoT/RT-Thread-for-JD/a73d6572b43d3c247c3ff0e446289e78.png)
