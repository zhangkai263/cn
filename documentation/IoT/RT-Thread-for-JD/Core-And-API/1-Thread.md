...
![传感器数据接收任务与显示任务的切换执行](media/576288ae412dfd7904e6934ee34d881f.png)
...
![对象容器与线程对象](media/8b94bf0d9dab069445c67403ae787950.png)
...
![线程栈 (ARM)](media/5677b9f0645056c02eac6990f2fe392c.png)
...
![相同优先级时间片轮转](media/4f56567fc70b4bed6d317a8ceffe5169.png)
...
![线程状态转换图](media/db67565c98326a0b8768f01919f4e9bd.png)

线程状态转换图

线程通过调用函数 rt_thread_create/init()
...
![主线程调用过程](media/de7ce929aa9d01f3a9714ef7f584bf5b.png)
...
![线程相关操作](media/043327507e156bd48269244b9a87268f.png)
...
调用该函数后，线程对象将会被移出线程队列并且从内核对象管理器中删除，线程占用的堆栈空间也会被释放，收回的空间将重新用于其他的内存分配。实际上，用
...
线程 2 计数到一定值会执行完毕，线程 2 被系统自动删除，计数停止。线程 1
一直打印计数。
