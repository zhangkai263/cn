...
![Operation-Maintenance-And-Monitoring-7](../../../../image/JD-Cloud-Swift/Operation-Maintenance-And-Monitoring-7.png)
...
![Operation-Maintenance-And-Monitoring-8](../../../../image/JD-Cloud-Swift/Operation-Maintenance-And-Monitoring-8.png)
...
![Operation-Maintenance-And-Monitoring-9](../../../../image/JD-Cloud-Swift/Operation-Maintenance-And-Monitoring-9.png)
...
![Operation-Maintenance-And-Monitoring-10](../../../../image/JD-Cloud-Swift/Operation-Maintenance-And-Monitoring-10.png)

在此页面输入主机集合名称、可用域名称，点击“确定”按钮，弹出“创建成功”提示，您可以在主机集合列表页面中看到您所创建的主机集合和可用域，如图：主机集合列表页面所示。

图：主机集合列表页面

![Operation-Maintenance-And-Monitoring-11](../../../../image/JD-Cloud-Swift/Operation-Maintenance-And-Monitoring-11.png)

在此页面，点击操作列的“添加主机”操作项，弹出添加主机页面，如图：添加主机页面所示。

图：添加主机页面

![Operation-Maintenance-And-Monitoring-12](../../../../image/JD-Cloud-Swift/Operation-Maintenance-And-Monitoring-12.png)

在此页面，选中添加的主机信息，点击“确定”按钮，弹出添加成功提示，则在主机集合与可用域列表页中，可以看到添加的主机信息，如图：主机集合列表页面所示。

图：主机集合列表页面

![Operation-Maintenance-And-Monitoring-13](../../../../image/JD-Cloud-Swift/Operation-Maintenance-And-Monitoring-13.png)
...
![Operation-Maintenance-And-Monitoring-14](../../../../image/JD-Cloud-Swift/Operation-Maintenance-And-Monitoring-14.png)
