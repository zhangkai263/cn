...
+ ### 房间相关
    ...
    - #### enterRoom
        ...
        |参数||
        |---|---|
        |joinroomInfo|JRTCJoinRoomInfo{<br>ver : 1.0<br>roomId : 104<br>peerId : 10733<br>nickName : zhanghao27<br>appId : 9f3440230172c69b5e01b1ad1ea7c6c7<br>token : NGVTSUUwYlBIdTV5TnZweWVvaTZWaXFEdUNKU1lnVmhtYmdUVUkrUlB1WT0<br>userId : 6fKFbW0B<br>nonce : ak-12a1521482145<br>timestamp : 1625220102000<br>roomType : 2<br>}<br>用户token计算<br>https://cf.jd.com/pages/viewpage.action?pageId=397719711
...
+ ### 视频相关
    - #### setVideoEncodingParam
        ...
        |参数||
        |---|---|
        |JRTCEncodeParams|resolution 分辨率<br>JRTC_VIDEO_RESOLUTION_360P<br>JRTC_VIDEO_RESOLUTION_720P<br>JRTC_VIDEO_RESOLUTION_1080P<br>fps帧率<br>JRTC_VIDEO_FPS_15<br>JRTC_VIDEO_FPS_20<br>JRTC_VIDEO_FPS_25<br>JRTC_VIDEO_FPS_30
        - ##### 注意
...
+ ### 消息
    - #### sendMessage
        ...
        TextMessage textMessage = TextMessage.obtain("test message");<br>
        ConversationType type = ConversationType.RTC_ROOM;<br>
