...
8、网口数量与名称：选择所需的网口数量及名称。若选择单网口，对应网口名称主网口（bond0）;若选择双网口，对应网口名称主网口（eth0）和辅网口（eth1）。<br/>

9、选择网口与带宽设置：若选择单网口，则此处为主网口（bond0）信息；若选择双网口，则此处为主网口（eth0）和辅网口（eth1）信息。下面以双网口为例：<br/>
...
13、 点击**立即购买**按钮，跳转到订单确认页。按照京东云统一的订单计费流程支付成功后，跳转回控制台列表页面。
