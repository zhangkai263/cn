...
详细说明：
提前支付数月或数年的费用，目前购买时间段支持1个月~9个月、1年、2年、3年；费用在您创建资源时一次性扣除；示例：您在2017-8-2 10:00:00购买1个月1M带宽、0M额外上行带宽的电信弹性公网IP，月单价总和为24元，则您需要支付的费用为24=24* 1元，您可以使用该资源至2017-9-2 23:59:59。
...
- 打开控制台，在左侧导航栏点击共享带宽列表页，选择目标共享带宽，点击操作中的 **修改带宽** 按钮，弹框选择需要调整的带宽，额外上行带宽大小，即可完成操作。<br/>

### 续费

- 打开控制台，在左侧导航栏点击共享带宽列表页，选择目标共享带宽，点击操作中的 **续费** 按钮，或进入详情页后点击操作中的 **删除** 按钮，弹框选择需要续费的时长，点击 **续费** 按钮，跳转到“支付确认页面”，点击“立即支付”，即可完成操作。<br/>
按配置计费的共享带宽不支持续费操作。

### 删除

- 打开控制台，在左侧导航栏点击共享带宽列表页，选择目标共享带宽，点击操作中的 **删除** 按钮，点击“确认”按钮，即可完成操作。<br/>
