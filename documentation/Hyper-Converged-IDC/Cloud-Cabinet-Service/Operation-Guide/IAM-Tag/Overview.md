...
支持编辑标签的资源：[机柜](../Resources-Management/View-Cabinet-List.md)，[设备](../Resources-Management/View-Device-List.md)，[公网IP](../Resources-Management/View-ipAddress-List.md)，[带宽（出口）](../Resources-Management/View-Bandwidth-List.md)，[报警规则](../Resources-Management/View-Alarm-Rules.md)</br>
### 详细操作
