**本试用服务条款是京东云网站所有者（本协议中称为“京东云”网址：www.jdcloud.com ）与您就分布式数据库TiDB相关事项所订立的有效合约。您通过盖章、网络页面点击确认或以其他方式选择接受本试用服务条款，包括但不限于未点击确认本试用服务条款而事实上使用了京东云分布式数据库TiDB试用服务，即表示您与京东云已达成协议并同意接受本试用服务条款的全部约定内容。如若双方盖章文本与网络页面点击确认或以其他方式选择接受之服务条款文本，存有不一致之处，以双方盖章文本为准。**
