**本试用服务条款是京东智联云网站所有者（本协议中称为“京东智联云”网址：**[www.jdcloud.com](https://www.jdcloud.com/) **）与您就分布式关系数据库DRDS相关事项所订立的有效合约。您通过盖章、网络页面点击确认或以其他方式选择接受本试用服务条款，包括但不限于未点击确认本试用服务条款而事实上使用了京东智联云分布式关系数据库DRDS试用服务，即表示您与京东智联云已达成协议并同意接受本试用服务条款的全部约定内容。如若双方盖章文本与网络页面点击确认或以其他方式选择接受之服务条款文本，存有不一致之处，以双方盖章文本为准。**
...
1.1本条款中“服务”指：京东智联云向您提供[www.jdcloud.com](https://www.jdcloud.com/)网站上所展示的分布式关系数据库DRDS试用服务以及相关的技术及网络支持服务。
...
3.2.3 若服务涉及分布式关系数据库DRDS的，京东智联云仅负责数据库系统以下的底层部分及京东智联云提供的软件的运营维护，即分布式关系数据库DRDS的相关技术架构及操作系统等。数据库之上的应用部分由您自行负责。
