**<div align=center>通用图片搜索服务条款</div>**

**本服务条款是北京沃东天骏信息技术有限公司（本协议中称为“京东智联云”）与您就通用图片搜索服务的相关事项所订立的有效合约。您通过盖章、网络页面点击确认或以其他方式选择接受本服务条款，包括但不限于未点击确认本服务条款而事实上使用了京东智联云通用图片搜索服务，即表示您与京东智联云已达成协议并同意接受本服务条款的全部约定内容。如若双方盖章文本与网络页面点击确认或以其他方式选择接受之服务条款文本，存有不一致之处，以双方盖章文本为准。**
...
1.2. 京东智联云通用图片搜索服务，基于京东海量商品数据及丰富购物场景，支持对图片、视频场景中对商品的识别，获得物品的商品类别和名称，支持在购物场景下的内容分析及拍照视图的服务。
...
3.2.3 若服务涉及通用商品识别的，京东智联云仅负责操作系统以下的底层部分及京东智联云提供的软件的运营维护，即通用图片搜索服务的相关技术架构及操作系统等。操作系统之上部分 （如您在系统上安装的应用程序）由您自行负责。此外，您自行升级操作系统可能会造成宕机等不良影响，请自行把握风险并谨慎操作。
...
7.1. 服务期限自您创建任一通用图片搜索服务【业务侧需确认该服务是否可以一一创建】（指jcloud.com上所向您展示并提供的服务）成功之日起计算。具体服务期限将根据您实际使用情况计算。
...
7.3.2. 您关停任一通用图片搜索服务【业务侧需确认是否可以向一个用户同时提供多个该服务】，京东智联云将停止提供该通用商品识别的服务；如您关停所有通用图片搜索服务，本服务条款终止；
