...
（1）对于单实例维度，京东云承诺一个服务周期内中心可用区云主机的服务可用性不低于99.99%，边缘可用区云主机的服务可用性不低于99.9%；
...
（1）对于单实例，如中心可用区服务可用性低于99.99%，边缘可用区服务可用性低于99.9%，可按照下表中的标准获得赔偿，赔偿方式仅限于用于发放购买云主机产品的代金券，且赔偿的代金券总额不超过未达到服务可用性承诺当月客户就该实例支付的单实例月度服务费金额（不含用免费代金券抵扣的费用）。
