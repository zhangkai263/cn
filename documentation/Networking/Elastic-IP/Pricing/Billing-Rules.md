...
- 计费模式转换：按配置计费可通过续费转成包年包月计费类型，计费类型转换不可逆，具体操作请参考[续费弹性公网IP](../Operation-Guide/Elastic-IP-Management/Renew-Elastic-IP.md)。
...
- 计费模式转换：按用量计费可通过续费转成包年包月计费类型，计费类型转换不可逆，具体操作请参考[续费弹性公网IP](../Operation-Guide/Elastic-IP-Management/Renew-Elastic-IP.md)。
