...
5. 后端服务设置：
	...
	**基本信息：**
     ...
     **注意事项<br>**
           ● **当客户端源IP数量较少并且业务类型为无状态业务时，推荐使用加权五元组算法，这样可使业务请求更均匀的分布到不同的后端服务器**<br><br>
           ● **使用加权源IP算法，在后端服务器比较稳定的情况下，可以实现基于源IP的会话保持。增加或减少后端服务器数量，将可能导致源IP地址请求转发到不同的后端服务器。如业务需要会话保持功能，建议开启会话保持功能**<br><br>
