...
#### **步骤六、编辑路由规则**
 ...
 5. 下一跳类型，支持Internet和云主机、边界网关、VPC对等连接、NAT网关作为下一跳类型，其中IPv6路由策略的下一跳类型支持云主机、VPC对等连接和Internet，流量若要访问Internet，可选择Internet网关，或自建云主机作为公网网关；
