...
7. 子网的CIDR只能是内网网段，其中IPv4网段可选范围为10.0.0.0(掩码为16\~28)、172.16.0.0\~172.31.0.0(掩码为16\~28)、192.168.0.0(掩码为16\~28)；IPv6子网段在私有网络所在的网段下选择，可选范围为00\~ff。
...
8. 子网的CIDR只能是内网网段，可选范围为10.0.0.0(掩码为16\~28)、172.16.0.0\~172.31.0.0(掩码为16\~28)、192.168.0.0(掩码为16\~28)。
