...
专线服务对客户端设备的要求，详见[使用限制](../Introduction/Restrictions.md)。
...
###### 步骤3.创建专线连接
详见[专线连接公有云](../Getting-Started/Connection-Into-On-Premise.md)。

###### 步骤4.创建VPN连接
详见[VPN连接公有云](https://docs.jdcloud.com/cn/vpn/connection-into-on-premise)。
