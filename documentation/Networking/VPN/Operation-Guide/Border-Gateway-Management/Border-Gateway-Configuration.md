...
![](../../../../../image/Networking/Virtual-Private-Network/Operation-Guide/create-bgw.png)
...
![](../../../../../image/Networking/Virtual-Private-Network/Operation-Guide/update-bgw.png)

##### 3.删除边界网关
若您不再需要边界网关，可将其删除。</br>
a)登录[京东云边界网关控制台](https://cns-console.jdcloud.com/host/borderGateway/list)；  </br>
b)选择要删除的边界网关，点击操作列中的“删除”，当该边界网关未创建专线通道、托管通道、VPN连接、VPC接口时可以删除；</br>
![](../../../../../image/Networking/Virtual-Private-Network/Operation-Guide/delete-bgw.png)
