...
- [修改公网IP带宽上限](instance-type-family#user-content-2)
...
**步骤3：** 定位要添加的共享带宽包，点击添加EIP按钮，选择需要添加的公网IP，然后点击确定；
```
...
在某个共享带宽包中修改公网IP带宽上限，需先定位共享带宽包，再对公网IP进行单个或者批量限速。具体操作步骤如下：
