...
裸金属云主机是基于京东智联云新一代自研虚拟化技术架构**京刚**推出的云主机实例类型，同时兼顾物理机性能及虚拟机灵活性。与上一代虚拟化技术架构相比，新一代虚拟化技术架构不再有任何虚拟化开销，提供物理级别的资源隔离，支持嵌套虚拟化，您的业务可直接访问裸金属云主机上的计算资源，保障您的业务安全。
...
* 	仅支持京东智联云在华北-北京地域2020年1月2日及之后提供的以下官方镜像：CentOS 7.2、CentOS 7.4及CentOS 7.6，以及基于上述官方镜像创建的云主机而制作的私有镜像，若您需要将已有私有镜像转换为支持创建裸金属云主机的镜像，请参考 [创建裸金属云主机](Create-BM-Instance.md)
*  	仅支持云硬盘作系统盘
* 	不支持配置多网卡，仅支持单网卡（主网卡）
