...
## 接入流程
京东智联云OAuth2.0服务是一系列HTTPS接口。应用开发者需要先在 [应用管理控制台](https://ias-console.jdcloud.com/ias/apps) 获取Client_ID（请参考[《创建和管理应用》](../../../IAS/Application-Management/createApp.md)），然后按以下步骤开发实现授权登录：
