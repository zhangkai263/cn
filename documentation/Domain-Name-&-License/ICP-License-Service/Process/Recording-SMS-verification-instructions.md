...
|取消接入       |无                               |取消接入成功后如果您继续使用京东智联云接入商的服务器，<br/>您的网站将会被阻断访问，不会影响您在其他友商处的备案信息；<br/>如果您的备案信息没有对应的接入商，根据相关法律法规，相关<br/>部门可能会注销您的备案号|

### 特殊说明：如果您的域名在其他友商（原备案接入商）存在备案，现接入京东智联云的过程中无法接收工信部验证短信，建议您到友商核实报备的手机号码后，再次提交审核。
