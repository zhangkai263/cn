...
项目创建路径：工作台主页--创建新项目
![项目](/image-agile/2.png)
### 定义需求（缺陷，任务）交付流程
创建项目后确定项目目标，时间，人员后需要讨论需求交付流程，进行工作项管理配置。

比较简单的流程如下：

![流程](/image-agile/流程.png)
...
按照上面的流程运行，各阶段定义如下：
![需求](/image-agile/需求阶段.png)

任务：具体分配给个人的工作内容

![任务](/image-agile/任务阶段.png)
...
![评审](/image-agile/8.png)
![图表](/image-function/迭代图表.png)
