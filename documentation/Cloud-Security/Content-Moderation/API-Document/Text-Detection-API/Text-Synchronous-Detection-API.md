...
| 功能         | 描述                                                         | scene    | label                                                        |
| :----------- | :----------------------------------------------------------- | :------- | :----------------------------------------------------------- |
| 垃圾文本检测 | 结合行为、内容，采用多维度、多模型、多检测手段，识别文本中的垃圾内容，规避色情、广告、灌水、渉政、辱骂等内容风险。 | antispam | normal：正常文本<br /> ad：广告<br />politics：涉政<br />terrorism：暴恐 <br />abuse：辱骂       <br />porn：色情<br />contraband：违禁<br />other：其他 |
