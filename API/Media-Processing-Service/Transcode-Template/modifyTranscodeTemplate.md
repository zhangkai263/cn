...
|**video**|[VideoStreamSettings](modifytranscodetemplate#videostreamsettings)|False| |视频参数配置|
|**audio**|[AudioStreamSettings](modifytranscodetemplate#audiostreamsettings)|False| |音频参数配置|
|**container**|[ContainerSettings](modifytranscodetemplate#containersettings)|False| |封装容器配置|
|**encryption**|[EncryptionSettings](modifytranscodetemplate#encryptionsettings)|False| |加密配置|
...
|名称|类型|是否必需|默认值|描述|
|---|---|---|---|---|
|**hlsKey**|String|False| |加密Key。HLS AES129KEY，必须为 16 个 ASCII 可打印字符<br>|
...
|**sampleRate**|Integer|True| |音频采样率。取值范围：22050、24000、32000、44100、48000、64000、88200、96000<br>当容器封装格式为 flv 时，只支持 22050、44100<br>|
...
|**rcmode**|String|False| |码率质量控制模式。取值范围：<br>  crf - 恒定码率系数模式。设置此模式时，rateFactor 生效，bitrate 会被忽略<br>  abr - 平均码率模式。设置此模式时，bitrate 生效，rateFactor 会被忽略<br>默认值为 abr<br>|
|**rateFactor**|String|False| |码率质量控制因子。取值范围：[0, 51]，支持2位小数的浮点数<br>当 codec 为 h264 时，默认值为 23；当 codec 为 h265 时，默认值为 28<br>|
...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](modifytranscodetemplate#result)|修改转码模板结果|
...
|**video**|[VideoStreamSettings](modifytranscodetemplate#videostreamsettings)|视频参数配置|
|**audio**|[AudioStreamSettings](modifytranscodetemplate#audiostreamsettings)|音频参数配置|
|**container**|[ContainerSettings](modifytranscodetemplate#containersettings)|容器设置|
|**encryption**|[EncryptionSettings](modifytranscodetemplate#encryptionsettings)|加密配置|
...
|名称|类型|描述|
|---|---|---|
|**hlsKey**|String|加密Key。HLS AES129KEY，必须为 16 个 ASCII 可打印字符<br>|
...
|**rcmode**|String|码率质量控制模式。取值范围：<br>  crf - 恒定码率系数模式。设置此模式时，rateFactor 生效，bitrate 会被忽略<br>  abr - 平均码率模式。设置此模式时，bitrate 生效，rateFactor 会被忽略<br>默认值为 abr<br>|
|**rateFactor**|String|码率质量控制因子。取值范围：[0, 51]，支持2位小数的浮点数<br>当 codec 为 h264 时，默认值为 23；当 codec 为 h265 时，默认值为 28<br>|
