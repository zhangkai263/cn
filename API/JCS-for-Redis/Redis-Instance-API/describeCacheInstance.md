...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](user-content-describecacheinstance#result)|结果|
|**requestId**|String|本次请求ID|

### <div id="Result">Result</div>
|名称|类型|描述|
|---|---|---|
|**cacheInstance**|[CacheInstance](user-content-describecacheinstance#cacheinstance)|实例的详细信息|
...
|**azId**|[AzId](user-content-describecacheinstance#azid)|az信息|
|**vpcId**|String|实例所属VPC ID|
|**subnetId**|String|实例所属子网ID|
|**connectionDomain**|String|实例的访问域名|
|**port**|Integer|实例的访问端口|
|**charge**|[Charge](user-content-describecacheinstance#charge)|实例的计费信息|
...
|**tags**|[Tag[]](user-content-describecacheinstance#tag)|标签信息|
