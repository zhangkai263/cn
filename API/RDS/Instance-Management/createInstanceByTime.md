...
|**instanceSpec**|[RestoredNewDBInstanceSpec](createinstancebytime#restorednewdbinstancespec)|True| |新建实例规格|
...
|**chargeSpec**|[ChargeSpec](createinstancebytime#chargespec)|True| |计费规格，包括计费类型，计费周期等|
