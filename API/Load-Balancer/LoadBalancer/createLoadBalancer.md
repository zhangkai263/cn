...
|**chargeSpec**|[ChargeSpec](#chargespec)|False| |【alb】支持按用量计费，默认为按用量。【nlb】支持按用量计费。【dnlb】支持按配置计费|
|**elasticIp**|[ElasticIpSpec](#elasticipspec)|False| |负载均衡关联的弹性IP规格|
...
|**userTags**|[Tag[]](#tag)|False| |用户tag 信息|
