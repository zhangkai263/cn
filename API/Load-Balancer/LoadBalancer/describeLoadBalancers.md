...
|**filters**|[Filter[]](#filter)|False| |loadBalancerType - 负载均衡类型，取值为：alb、nlb、dnlb，默认alb，支持单个<br>loadBalancerIds - 负载均衡ID列表，支持多个<br>loadBalancerNames - 负载均衡名称列表，支持多个<br>vpcId - 负载均衡所在Vpc的Id，支持单个<br>|
...
|名称|类型|描述|
|---|---|---|
|**loadBalancers**|[LoadBalancer[]](#loadbalancer)|负载均衡资源信息列表|
