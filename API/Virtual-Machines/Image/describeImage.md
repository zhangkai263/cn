...
|名称|类型|描述|
|---|---|---|
|**result**|[Result](describeimage#result)| |
|**requestId**|String| |

### <div id="result">Result</div>
|名称|类型|描述|
|---|---|---|
|**image**|[Image](describeimage#image)|镜像详情|
...
|**dataDisks**|[InstanceDiskAttachment[]](describeimage#instancediskattachment)|镜像数据盘映射信息|
...
|**localDisk**|[LocalDisk](describeimage#localdisk)|本地磁盘配置|
|**cloudDisk**|[Disk](describeimage#disk)|云硬盘配置|
...
|**tags**|[Tag[]](describeimage#tag)|Tag信息|
### <div id="tag">Tag</div>
|名称|类型|描述|
|---|---|---|
|**key**|String|Tag键|
