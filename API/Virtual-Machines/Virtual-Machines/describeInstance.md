...
|**dataDisks**|[InstanceDiskAttachment[]](describeinstance#instancediskattachment)|数据盘配置|
|**primaryNetworkInterface**|[InstanceNetworkInterfaceAttachment](describeinstance#instancenetworkinterfaceattachment)|主网卡配置|
|**secondaryNetworkInterfaces**|[InstanceNetworkInterfaceAttachment[]](describeinstance#instancenetworkinterfaceattachment)|辅助网卡配置|
|**launchTime**|String|创建时间|
|**az**|String|云主机所在可用区|
|**keyNames**|String[]|密钥对名称|
|**charge**|[Charge](describeinstance#charge)|计费信息|
|**ag**|[Ag](describeinstance#ag)|高可用组，如果创建云主机使用了高可用组，此处可展示高可用组名称|
...
|**networkInterface**|[InstanceNetworkInterface](describeinstance#instancenetworkinterface)|网卡接口规范|
...
|**securityGroups**|[SecurityGroupSimple[]](describeinstance#securitygroupsimple)| |
|**sanityCheck**|Integer|源和目标IP地址校验，取值为0或者1|
|**primaryIp**|[NetworkInterfacePrivateIp](describeinstance#networkinterfaceprivateip)|网卡主IP|
|**secondaryIps**|[NetworkInterfacePrivateIp[]](describeinstance#networkinterfaceprivateip)|网卡辅IP|
...
|**localDisk**|[LocalDisk](describeinstance#localdisk)|本地磁盘配置|
|**cloudDisk**|[Disk](describeinstance#disk)|云硬盘配置|
...
|**attachments**|[DiskAttachment[]](describeinstance#diskattachment)|挂载信息|
...
|**charge**|[Charge](describeinstance#charge)|云硬盘计费配置信息|
|**tags**|[Tag[]](describeinstance#tag)|Tag信息|
